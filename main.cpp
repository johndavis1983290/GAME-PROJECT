...
int main(int argc, char *argv[])
{
    ...
    otherfish fish1[NUM_FISH1];
      for(int i=0; i< NUM_FISH1; i++){
       ...
       fish1[i].currentTexture = graphics.loadTexture("otherfish_right(1).png");
       fish1[i].leftTexture[0] = graphics.loadTexture("otherfish_left(1).png");
       fish1[i].leftTexture[1] = graphics.loadTexture("otherfish_left(2).png");
       fish1[i].leftTexture[2] = graphics.loadTexture("otherfish_left(3).png");
       fish1[i].leftTexture[3] = graphics.loadTexture("otherfish_left(4).png");
       fish1[i].leftTexture[4] = graphics.loadTexture("otherfish_left(5).png");
       fish1[i].leftTexture[5] = graphics.loadTexture("otherfish_left(6).png");
       fish1[i].rightTexture[0] = graphics.loadTexture("otherfish_right(1).png");
       fish1[i].rightTexture[1] = graphics.loadTexture("otherfish_right(2).png");
       fish1[i].rightTexture[2] = graphics.loadTexture("otherfish_right(3).png");
       fish1[i].rightTexture[3] = graphics.loadTexture("otherfish_right(4).png");
       fish1[i].rightTexture[4] = graphics.loadTexture("otherfish_right(5).png");
       fish1[i].rightTexture[5] = graphics.loadTexture("otherfish_right(6).png");
      }
    ...
    otherfish fish2[NUM_FISH2];
      for(int i=0; i < NUM_FISH2; i++){
       ...
       fish2[i].currentTexture = graphics.loadTexture("otherfish(2)_right(1).png");
       fish2[i].leftTexture[0] = graphics.loadTexture("otherfish(2)_left(1).png");
       fish2[i].leftTexture[1] = graphics.loadTexture("otherfish(2)_left(2).png");
       fish2[i].leftTexture[2] = graphics.loadTexture("otherfish(2)_left(3).png");
       fish2[i].leftTexture[3] = graphics.loadTexture("otherfish(2)_left(4).png");
       fish2[i].leftTexture[4] = graphics.loadTexture("otherfish(2)_left(5).png");
       fish2[i].leftTexture[5] = graphics.loadTexture("otherfish(2)_left(6).png");
       fish2[i].rightTexture[0] = graphics.loadTexture("otherfish(2)_right(1).png");
       fish2[i].rightTexture[1] = graphics.loadTexture("otherfish(2)_right(2).png");
       fish2[i].rightTexture[2] = graphics.loadTexture("otherfish(2)_right(3).png");
       fish2[i].rightTexture[3] = graphics.loadTexture("otherfish(2)_right(4).png");
       fish2[i].rightTexture[4] = graphics.loadTexture("otherfish(2)_right(5).png");
       fish2[i].rightTexture[5] = graphics.loadTexture("otherfish(2)_right(6).png");
      }
    bool quit = false;
    SDL_Event event;
    while(!quit){
